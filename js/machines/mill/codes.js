...
export const MILL = {
  ...
  addresses: {
    ...
    D: 'Correttore di raggio utensile (G41/G42)'
  },
  ...
  g: {
    ...
    18: { group: 2, desc: 'Piano di lavoro ZX', status: 'planned' },
    19: { group: 2, desc: 'Piano di lavoro YZ', status: 'planned' },
    ...
    41: { group: 7, desc: 'Compensazione raggio utensile a sinistra', status: 'planned' },
    42: { group: 7, desc: 'Compensazione raggio utensile a destra', status: 'planned' },
